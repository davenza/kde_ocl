...
n_test = 10000000
print(n_train, "train instances.", n_test, "test instances.")
train = np.random.multivariate_normal([0,0], [[1,0],[0,1]], 1000)
test = np.random.multivariate_normal([0,0], [[3,2],[2,3]], 10000000)
...
n_test = 10000
print(n_train, "train instances.", n_test, "test instances.")
train = np.random.multivariate_normal([0,0], [[1,0],[0,1]], 100)
test = np.random.multivariate_normal([0,0], [[3,2],[2,3]], 10000)
