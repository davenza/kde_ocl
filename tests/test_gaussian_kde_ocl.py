...
def test_pdf_1d_rowmajor_rowmajor(n_train, n_test):
    np.random.seed(0)
...
@pytest.mark.parametrize("n_train, n_test", [(100000, 1000), (1000, 10000000), (100, 10000)])
def test_pdf_2d_rowmajor_rowmajor(n_train, n_test):
    np.random.seed(0)
...
@pytest.mark.parametrize("n_train, n_test", [(100000, 1000), (1000, 10000000), (100, 10000)])
def test_pdf_1d_rowmajor_columnmajor(n_train, n_test):
    np.random.seed(0)
    train = np.random.normal(0, 1.8, n_train)
    test = np.asfortranarray(np.random.normal(0.5, 2.3, n_test))
...
@pytest.mark.parametrize("n_train, n_test", [(100000, 1000), (1000, 10000000), (100, 10000)])
def test_pdf_2d_rowmajor_columnmajor(n_train, n_test):
    np.random.seed(0)
    train = np.random.multivariate_normal([0,0], [[1,0],[0,1]], n_train)
    test = np.asfortranarray(np.random.multivariate_normal([0,0], [[3,2],[2,3]], n_test))
...
@pytest.mark.parametrize("n_train, n_test", [(100000, 1000), (1000, 10000000), (100, 10000)])
def test_pdf_1d_columnmajor_rowmajor(n_train, n_test):
    np.random.seed(0)
    train = np.asfortranarray(np.random.normal(0, 1.8, n_train))
    test = np.random.normal(0.5, 2.3, n_test)
...
@pytest.mark.parametrize("n_train, n_test", [(100000, 1000), (1000, 10000000), (100, 10000)])
def test_pdf_2d_columnmajor_rowmajor(n_train, n_test):
    np.random.seed(0)
    train = np.asfortranarray(np.random.multivariate_normal([0,0], [[1,0],[0,1]], n_train))
    test = np.random.multivariate_normal([0,0], [[3,2],[2,3]], n_test)
...
@pytest.mark.parametrize("n_train, n_test", [(100000, 1000), (1000, 10000000), (100, 10000)])
def test_pdf_1d_columnmajor_columnmajor(n_train, n_test):
    np.random.seed(0)
    train = np.asfortranarray(np.random.normal(0, 1.8, n_train))
    test = np.asfortranarray(np.random.normal(0.5, 2.3, n_test))
...
@pytest.mark.parametrize("n_train, n_test", [(100000, 1000), (1000, 10000000), (100, 10000)])
def test_pdf_2d_columnmajor_columnmajor(n_train, n_test):
    np.random.seed(0)
    train = np.asfortranarray(np.random.multivariate_normal([0,0], [[1,0],[0,1]], n_train))
    test = np.asfortranarray(np.random.multivariate_normal([0,0], [[3,2],[2,3]], n_test))
...
@pytest.mark.parametrize("n_train, n_test", [(100000, 1000), (1000, 10000000), (100, 10000)])
def test_logpdf_1d(n_train, n_test):
    np.random.seed(0)
    train = np.random.normal(0, 1.8, n_train)
    test = np.random.normal(0.5, 2.3, n_test)
...
@pytest.mark.parametrize("n_train, n_test", [(100000, 1000), (1000, 10000000), (100, 10000)])
def test_logpdf_2d(n_train, n_test):
    np.random.seed(0)
    train = np.random.multivariate_normal([0,0], [[1,0],[0,1]], n_train)
    test = np.random.multivariate_normal([0,0], [[3,2],[2,3]], n_test)
